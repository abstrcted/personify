...
const Home = () => {
  ...
  }, [currentPage, sortBy, searchMode, fetchTracks]);
  ...
  // Show Spotify connection prompt at top if not authenticated
  const spotifyPrompt = !isAuthenticated && (
    <div className="spotify-connection-banner">
      <div className="banner-content">
        <div className="banner-text">
          <IconSparkles size={24} stroke={2} />
          <div>
            <strong>Connect Spotify for More Features!</strong>
            <p>Get access to your Top Tracks and Top Artists</p>
          </div>
        </div>
        <button onClick={login} className="btn btn-spotify-small">
  ...
  return (
    <div className="home-container-with-sidebar">
      ...
      <header className="page-header">
        <h1>Welcome{user ? ` back, ${user.display_name}` : ' to Personify'}! 👋</h1>
        <p className="page-subtitle">Browse {dbStats?.total_tracks?.toLocaleString() || '1.2 million'} tracks in our database</p>
      </header>
